...
public enum ErrorCodes {
   ...
   ONLY_ONE_GOAL_PER_COIN("THERE SHOULD ONE GOAL PER COIN", "009"),
   PROBLEM_WITH_EXTERNAL_API("THERE IS A PROBLEM WITH THE EXTERNAL API", "010"),
   WATCHLIST_RELATED_TO_A_CURRENCY("THIS WATCHLIST CONTAINS COINS CURRENTLY", "008");
