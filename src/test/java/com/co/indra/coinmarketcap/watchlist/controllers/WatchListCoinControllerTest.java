...
public class WatchListCoinControllerTest {
   ...
   public void removeCoinToWatchListHappyPath() throws Exception {
      ...
      MockHttpServletRequestBuilder requestRemoveCoinToWatchList = MockMvcRequestBuilders
            .delete(Routes.WATCHLIST_COIN_RESOURCE + Routes.DELETE_COIN_FROM_WATCHLIST, 187, 13)
   ...
   public void removeCoinToWatchListIDWatchListCoinNotExist() throws Exception {
      ...
      MockHttpServletRequestBuilder requestRemoveCoinToWatchList = MockMvcRequestBuilders
            .delete(Routes.WATCHLIST_COIN_RESOURCE + Routes.DELETE_COIN_FROM_WATCHLIST, 187, 44)
            .contentType(MediaType.APPLICATION_JSON);
   ...
   public void removeCoinToWatchListIDWatchListNotExist() throws Exception {
      ...
      MockHttpServletRequestBuilder requestRemoveCoinToWatchList = MockMvcRequestBuilders
            .delete(Routes.WATCHLIST_COIN_RESOURCE + Routes.DELETE_COIN_FROM_WATCHLIST, 277, 13)
            .contentType(MediaType.APPLICATION_JSON);
